...
export interface ApiAreaArea extends Schema.CollectionType {
  ...
  attributes: {
    ...
    children: Attribute.Relation<
      ...
      'api::area.area'
    >;
    parent: Attribute.Relation<'api::area.area', 'manyToOne', 'api::area.area'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiAscentAscent extends Schema.CollectionType {
...
export interface ApiBoulderBoulder extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::boulder.boulder': ApiBoulderBoulder;
    }
  }
}
